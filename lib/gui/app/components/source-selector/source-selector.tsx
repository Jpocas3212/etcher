...
import { Checkbox, Input, Modal } from 'rendition';
...
const presets = [
	{
		label: 'Raspbian Buster with desktop and recommended software',
		link:
			'http://downloads.raspberrypi.org/raspbian_full/images/raspbian_full-2020-02-14/2020-02-13-raspbian-buster-full.zip',
		icon: 'http://downloads.raspberrypi.org/raspbian/Raspbian.png',
	},
	{
		label: 'Raspbian Buster with desktop',
		link:
			'http://downloads.raspberrypi.org/raspbian/images/raspbian-2020-02-14/2020-02-13-raspbian-buster.zip',
		icon: 'http://downloads.raspberrypi.org/raspbian/Raspbian.png',
	},
	{
		label: 'Raspbian Buster Lite',
		link:
			'http://downloads.raspberrypi.org/raspbian_lite/images/raspbian_lite-2020-02-14/2020-02-13-raspbian-buster-lite.zip',
		icon: 'http://downloads.raspberrypi.org/raspbian/Raspbian.png',
	},
	{
		label: 'Ubuntu 18.04.4',
		link: 'http://releases.ubuntu.com/18.04/ubuntu-18.04.4-desktop-amd64.iso',
		icon: 'https://assets.ubuntu.com/v1/85a9de76-ubuntu-icon.svg',
	},
	{
		label: 'Ubuntu 19.10',
		link: 'http://releases.ubuntu.com/19.10/ubuntu-19.10-desktop-amd64.iso',
		icon: 'https://assets.ubuntu.com/v1/85a9de76-ubuntu-icon.svg',
	},
];
					...
					return (
						<Checkbox
							...
							label={
								<span>
									{preset.icon && (
										<SVGIcon width="20px" height="20px" paths={[preset.icon]} />
									)}
									{preset.label}
								</span>
							}
							onChange={() => {
								setImageURL(preset.link);
							}}
							checked={imageURL === preset.link}
						/>
					);
				})}
			</div>
